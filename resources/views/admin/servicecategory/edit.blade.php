        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="card card-primary">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form method="post" action="{{route('servicecategory.update', $servicecategory->id)}}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <input type="text" class="form-control col-sm-8" id="name" name="name" value="{{$servicecategory->name}}" required>
                            </div>
                            ...
                            <div class="form-group row">
                             ...
                             <textarea name="description" id="description" cols="92" rows="5">{{$servicecategory->description}}</textarea>
                            </div>
                            
                            <div class="custom-control custom-checkbox">
                                <input class="custom-control-input" type="checkbox" id="is_featured" name="is_featured" @if($servicecategory->is_featured == 'on') checked  @endif >
